...
import com.android.glory.Activity.Activity_live;
import com.android.glory.Adapter.Adapter_MyMatches;
import com.android.glory.Adapter.MymatchesLiveAdapter;
...
public class Fragment_MyMatchesLive extends Fragment implements MymatchesLiveAdapter.OnItemClickcourses{
    ...
    private void matchesList() {
      ...
      //  Call<Example> login = api.MyMatchesList("LIVE",viewuseremail);
        ...
        Call<LiveMyMatchesExample> login = api.MyMatchesListLive("LIVE",viewuseremail);
