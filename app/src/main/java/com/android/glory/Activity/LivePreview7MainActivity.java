...
import com.android.glory.Model.LivePointsDataModel.LivePointsDatum;
...
public class LivePreview7MainActivity extends AppCompatActivity {
    ...
    TextView xTvHitterPoints7, xTvPlayer2Points7, xTvPlayer3Points7, xTvPlayer4Points7, xTvPlayer5Points7,xTvPlayer6Points7,xTvPlayer7Points7,xTvTotalPoints;
    ...
    private void mInitWidgets() {
        ...
        xTvHitterPoints7 = (TextView) findViewById(R.id.xTvHiiterPoints7);
        xMainHitter7 = (ImageView) findViewById(R.id.xMainHitter7);

        xBtnPlayer2Name7 = (Button) findViewById(R.id.xBtnPlayer2Name7);
        xTvPlayer2Points7 = (TextView) findViewById(R.id.xTvPlayer2Points);
        player27 = (ImageView) findViewById(R.id.player2);
                        ...
                        for (int j = 0; j < list.size(); j++) {
                            ...
                            if (j == 0) {
                                if (!playerListDatum.getLivePointsPlayerScore().getPowerHitterPoints().isEmpty())
                                    xTvHitterPoints7.setText(playerListDatum.getLivePointsPlayerScore().getPowerHitterPoints());
                                else
                                    xTvHitterPoints7.setText("0");

                                xBtnHitterName7.setText(playerListDatum.getLivePointsPlayer().getFirstName());
                                ...
                                xBtnPlayer2Name7.setText(playerListDatum.getLivePointsPlayer().getFirstName());
                                if (playerListDatum.getLivePointsPlayer().getImageURL() == null || playerListDatum.getLivePointsPlayer().getImageURL().toString().length() == 0) {
                                    Glide.with(getApplicationContext())
                                            .load((R.drawable.player)).placeholder(R.drawable.player)
                                            .into(player27);
                                ...
                                xBtnPlayer3Name7.setText(playerListDatum.getLivePointsPlayer().getFirstName());
                                if (playerListDatum.getLivePointsPlayer().getImageURL()== null || playerListDatum.getLivePointsPlayer().getImageURL().toString().length() == 0) {
                                    Glide.with(getApplicationContext())
                                            .load((R.drawable.player)).placeholder(R.drawable.player)
                                            .into(player37);
                                ...
                                xBtnPlayer4Name7.setText(playerListDatum.getLivePointsPlayer().getFirstName());
                                if (playerListDatum.getLivePointsPlayer().getImageURL() == null || playerListDatum.getLivePointsPlayer().getImageURL().toString().length() == 0) {
                                    Glide.with(getApplicationContext())
                                            .load((R.drawable.player)).placeholder(R.drawable.player)
                                            .into(player47);
                                ...
                                xBtnPlayer5Name7.setText(playerListDatum.getLivePointsPlayer().getFirstName());
                                if (playerListDatum.getLivePointsPlayer().getImageURL() == null ||playerListDatum.getLivePointsPlayer().getImageURL().toString().length() == 0) {
                                    Glide.with(getApplicationContext())
                                            .load((R.drawable.player)).placeholder(R.drawable.player)
                                            .into(xPlayer57);
                                ...
                                xBtnPlayer6Name7.setText(playerListDatum.getLivePointsPlayer().getFirstName());
                                if (playerListDatum.getLivePointsPlayer().getImageURL() == null ||playerListDatum.getLivePointsPlayer().getImageURL().toString().length() == 0) {
                                    Glide.with(getApplicationContext())
                                            .load((R.drawable.player)).placeholder(R.drawable.player)
                                            .into(xPlayer67);
                                ...
                                xBtnPlayer7Name7.setText(playerListDatum.getLivePointsPlayer().getFirstName());
                                if (playerListDatum.getLivePointsPlayer().getImageURL() == null ||playerListDatum.getLivePointsPlayer().getImageURL().toString().length() == 0) {
                                    Glide.with(getApplicationContext())
                                            .load((R.drawable.player)).placeholder(R.drawable.player)
                                            .into(xPlayer77);
