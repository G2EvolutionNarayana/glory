...
//                }
                for (int i = 0; i < Team_1_Fragment.playerDetailsList.size(); i++) {
                    ...
                    if (playerDetails.getSelected()) {
                        FinalPlayerSelectionModel finalPlayerSelectionModel = new FinalPlayerSelectionModel(playerDetails.getPlayer().getFullName(), playerDetails.getPlayer().getImageURL(), playerDetails.getPlayer().getId());
                        finalPlayerList.add(finalPlayerSelectionModel);
                    }
                }
