                            ...
                            if (i == 0) {
                                ...
                                for (int j = 0; j < playerListDatum.getSelectedUsers().size(); j++) {
                                    ...
                                    if (j == 0) {
                                        ...
                                        xBtnHitterName7.setText(playerListDatum.getSelectedUsers().get(j).getPlaylistPlayer().getFirstName());
                                        ...
                                        xBtnPlayer2Name7.setText(play_listPlayer.getPlaylistPlayer().getFirstName());
                                        if (playerListDatum.getSelectedUsers().get(j).getPlaylistPlayer().getImageURL() == null || playerListDatum.getSelectedUsers().get(j).getPlaylistPlayer().getImageURL().toString().length() == 0) {
                                            Glide.with(getApplicationContext())
                                                    .load((R.drawable.player)).placeholder(R.drawable.player)
                                                    .into(player2);
                                        ...
                                        xBtnPlayer3Name7.setText(play_listPlayer.getPlaylistPlayer().getFirstName());
                                        if (playerListDatum.getSelectedUsers().get(j).getPlaylistPlayer().getImageURL() == null || playerListDatum.getSelectedUsers().get(j).getPlaylistPlayer().getImageURL().toString().length() == 0) {
                                            Glide.with(getApplicationContext())
                                                    .load((R.drawable.player)).placeholder(R.drawable.player)
                                                    .into(player3);
                                        ...
                                        xBtnPlayer4Name7.setText(play_listPlayer.getPlaylistPlayer().getFirstName());
                                        if (playerListDatum.getSelectedUsers().get(j).getPlaylistPlayer().getImageURL() == null || playerListDatum.getSelectedUsers().get(j).getPlaylistPlayer().getImageURL().toString().length() == 0) {
                                            Glide.with(getApplicationContext())
                                                    .load((R.drawable.player)).placeholder(R.drawable.player)
                                                    .into(player4);
                                        ...
                                        xBtnPlayer5Name7.setText(play_listPlayer.getPlaylistPlayer().getFirstName());
                                        if (playerListDatum.getSelectedUsers().get(j).getPlaylistPlayer().getImageURL() == null || playerListDatum.getSelectedUsers().get(j).getPlaylistPlayer().getImageURL().toString().length() == 0) {
                                            Glide.with(getApplicationContext())
                                                    .load((R.drawable.player)).placeholder(R.drawable.player)
                                                    .into(xPlayer5);
                                        ...
                                        xBtnPlayer6Name.setText(play_listPlayer.getPlaylistPlayer().getFirstName());
                                        if (playerListDatum.getSelectedUsers().get(j).getPlaylistPlayer().getImageURL() == null || playerListDatum.getSelectedUsers().get(j).getPlaylistPlayer().getImageURL().toString().length() == 0) {
                                            Glide.with(getApplicationContext())
                                                    .load((R.drawable.player)).placeholder(R.drawable.player)
                                                    .into(player6);
                                        ...
                                        xBtnPlayer7Name.setText(play_listPlayer.getPlaylistPlayer().getFirstName());
                                        if (playerListDatum.getSelectedUsers().get(j).getPlaylistPlayer().getImageURL() == null || playerListDatum.getSelectedUsers().get(j).getPlaylistPlayer().getImageURL().toString().length() == 0) {
                                            Glide.with(getApplicationContext())
                                                    .load((R.drawable.player)).placeholder(R.drawable.player)
                                                    .into(player7);
