...
import com.android.glory.Adapter.TransactionAdapter;
...
import static com.android.glory.R.layout.activity_transaction_list;
...
public class ActivityTransactionList extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(activity_transaction_list);
        mInitWidgets();
...
//                            Log.e("testing", "jsonArray = " + jsonArray);
                            ...
                            while (iter.hasNext()) {
                                ...
                                for (int i = 0; i < valueArray.length(); i++) {
                                    ...
                                    TransactionChildDataModel transactionChildDataModel = new TransactionChildDataModel(trans_code, trans_amount, trans_type);
